      ...
      <div className='productdisplay-right'>
            ...
            <div className='productdispaly-right-description'>
                A lightweight,Usually Knitted,Pullover shirts,close-fitting and with 
                 a round neckline and short sleeves,worn as an undershirt or outern
                 garment.
            </div>
            ...
            <p className='productdisplay-right-category'><span>Category :</span>women,T-shir , crop top </p>
